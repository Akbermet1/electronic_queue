...
from the_queue.views import (QueueInFirestoreListCreateView, QueueInFirestoreDetailView, QueueInFirestorePartialUpdateView,
                            CustomerInQueueCreateView, CustomerInQueueDetailView, QueueInFirebaseMoveView, )
...
urlpatterns = [
    ...
    path("<str:queue_id>/move/", QueueInFirebaseMoveView.as_view(), name="queue-in-firebase-move"),
